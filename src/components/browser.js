 ...
 export default  {
      ...
      methods: {
          init() {
              ...
              this.chartDomA = echarts.init(document.getElementById('chartDomA'));
              this.chartDomB = echarts.init(document.getElementById('chartDomB'));
              return this;
          },
          update() {
              if (this.chartDomA === null) {
                  this.init();
              }
              this.chartDomA.setOption({
                  title: {
